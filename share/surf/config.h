...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| sed \"s/^$2(STRING) = //;s/^\\\"\\(.*\\)\\\"$/\\1/\")\" " \
             "| dmenu -fn 'Droid Sans Mono-14' -nb '#555555' -nf '#FFFFFF' -sb '#FFFFFF' -sf '#000000' -p \"$4\" -w $1)\" && xprop -id $1 -f $3 8s -set $3 \"$prop\"", \
...
static Button buttons[] = {
	...
	{ OnAny,        0,              2,      clicknewwindow, { .i = 0 },     1 },
